...
import { Eye, FileText, Loader2, ExternalLink, Server, Copy, CheckCircle2 } from 'lucide-react';
        ...
        const response = await fetch(`${serverUrl}/generate-docs`, {
          ...
          body: JSON.stringify({
            ...
            selectedFile: {
              ...
              jsonContent: selectedFile.jsonContent
            },
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose an AI model and enter your API key to generate technical documentation.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="modelSelect" className="col-span-4">
              Select AI Model
            </Label>
            <Select
              value={selectedModel}
              onValueChange={(value) => setSelectedModel(value as 'claude' | 'gemini')}
            >
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="apiKey" className="col-span-4">
              {selectedModel === 'claude' ? 'Claude API Key' : 'Gemini API Key'}
            </Label>
            <Input
              id="apiKey"
              value={apiKey}
              onChange={(e) => setApiKey(e.target.value)}
              placeholder={`Enter your ${selectedModel === 'claude' ? 'Claude' : 'Gemini'} API key`}
              className="col-span-4"
              type="password"
            />
            <div className="col-span-4 text-xs text-gray-500">
              <a 
                href={selectedModel === 'claude' 
